...
class FaqController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin_faq')->with('succes','S.S.S Başarıyla Eklendi.');
    }
    ...
    public function update(Request $request, Faq $faq,$id)
    {
        ...
        return redirect()->route('admin_faq')->with('succes','S.S.S Başarıyla Güncellendi.');
    }
    ...
    public function destroy(Faq $faq,$id)
    {
        ...
        return redirect()->route('admin_faq')->with('succes','S.S.S Başarıyla Silindi.');
    }
}
